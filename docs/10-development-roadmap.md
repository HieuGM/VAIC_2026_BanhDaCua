...
## % Tiến độ
- [x] Phase 0: 100% · [ ] Phase 1: 0% (AI team) · [x] Phase 2: 100% (merged + deployed LIVE) · [ ] Phase 3: 0% · [~] Phase 4: deploy DONE, còn video/slide/desc · **CI/CD = phase kế tiếp** (GHCR + GitHub Actions, build off-VPS)
