#!/usr/bin/env python
"""Seed local HAPI FHIR with Vietnamese synthetic resources through FHIR REST."""
...
def main() -> int:
    try:
        seed_files = [
            SEED_DIR / "vietnamese-clinical-data-transaction-bundle.json",
        ]
        if not seed_files:
    ...
    print(f"Seeded {total_entries} Vietnamese synthetic FHIR resources through {FHIR_BASE_URL}")
    return 0
